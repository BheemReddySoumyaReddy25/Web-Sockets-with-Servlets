...
<body>
	...
	<script>	
		var websocket=new WebSocket("ws://localhost:8081/WebSocket4/VitalCheckEndPoint");
			...
			if(jsonData.message!=null)
				{
					...
					row.innerHTML="<td>"+details[0]+"</td><td>"+details[1]+"</td><td>"+details[2]+"</td><td>"+details[3]+"</td><td><button class=\"btn btn-danger btn-sm\" onclick=\"sendInstructions('"+details[0]+"','ambulance,"+details[3]+"')\">Summon Ambulance</button><button type=\"button\" class=\"btn btn-primary btn-sm\" onclick=\"sendInstructions('"+details[0]+"','medication')\">Suggest Medication</button></td>";
				}
		}
